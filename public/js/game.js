...
function update(time) {
  var self = this;
  if (this.ship) {
    self.physics.collide(self.ship, self.otherPlayers, function () {
      console.log("PLAYERS COLLIDED");
      console.log(self.otherPlayers, self.otherProjectiles);
    });
    self.physics.collide(self.ship, self.projectiles, function () {
      console.log(self.projectiles, self.otherProjectiles);
    });
...
function addProjectile(self, playerX, playerY, playerRotation) {
  self.projectile = self.physics.add
    .sprite(playerX, playerY, "projectile")
    .setOrigin(0.5, 0.5)
    .setSize(20, 20, true)
